...
FIXTURE_METADATA: list[dict] = [
    ...
    {"field_name": "scr_bg_income", "form_name": "screening_rural", "field_type": "text", "field_label": "Monthly family income"},
    {"field_name": "screening_rural_complete", "form_name": "screening_rural", "field_type": "text", "field_label": "Complete?"},
    {
        "field_name": "q1_tv_freq",
        "form_name": "dseq",
        "field_type": "radio",
        "field_label": "TV frequency",
        "select_choices_or_calculations": "0, Never /transliteration | 1, 1-2 days/week /transliteration",
    },
    {
        "field_name": "q9_household_rules",
        "form_name": "dseq",
        "field_type": "radio",
        "field_label": "Household screen-use rules",
        "select_choices_or_calculations": "1, Yes /transliteration | 0, No /transliteration",
    },
    {
        "field_name": "q10_total_screen_time",
        "form_name": "dseq",
        "field_type": "radio",
        "field_label": "Average total daily screen time",
        "select_choices_or_calculations": "1, Less than 30 minutes /transliteration | 2, 30 minutes-1 hour /transliteration",
    },
    {
        "field_name": "q14_school_use",
        "form_name": "dseq",
        "field_type": "radio",
        "field_label": "Uses screens for school/homework",
        "select_choices_or_calculations": "1, Yes /transliteration | 0, No /transliteration",
    },
    {
        "field_name": "q15_entertainment_use",
        "form_name": "dseq",
        "field_type": "radio",
        "field_label": "Uses screens mainly for entertainment",
        "select_choices_or_calculations": "1, Yes /transliteration | 0, No /transliteration",
    },
    {"field_name": "dseq_complete", "form_name": "dseq", "field_type": "text", "field_label": "Complete?"},
    {
        "field_name": "chh_illness_current",
        "form_name": "child_illness_history",
        "field_type": "radio",
        "field_label": "Currently ill",
        "select_choices_or_calculations": "0, No /transliteration | 1, Yes /transliteration",
    },
    {
        "field_name": "chh_q8_asthma",
        "form_name": "child_illness_history",
        "field_type": "radio",
        "field_label": "Asthma",
        "select_choices_or_calculations": "0, No /transliteration | 1, Yes /transliteration",
    ...
    {"field_name": "paq_item1_score", "form_name": "paq_c", "field_type": "calc", "field_label": "PAQ-C item 1 score"},
    {"field_name": "paq_item8_score", "form_name": "paq_c", "field_type": "calc", "field_label": "PAQ-C item 8 score"},
    {"field_name": "paq_total_score", "form_name": "paq_c", "field_type": "calc", "field_label": "PAQ-C total score"},
    {"field_name": "paq_c_complete", "form_name": "paq_c", "field_type": "text", "field_label": "Complete?"},
    {
        "field_name": "die_grains_freq",
        "form_name": "dietary_intake",
        "field_type": "radio",
        "field_label": "Grains frequency",
        "select_choices_or_calculations": "1, Daily /transliteration | 2, 3-6 per week /transliteration",
    },
...
def build_fixture_records(as_of: date) -> list[dict]:
    ...
    return [
        ...
        _base_record(
            ...
            scr_bg_income="15000",
            q1_tv_freq="1",
            q9_household_rules="1",
            q10_total_screen_time="2",
            q14_school_use="0",
            q15_entertainment_use="1",
            chh_illness_current="0",
            chh_q8_asthma="1",
            paq_item1_score="2.5",
            paq_item8_score="3.5",
            paq_total_score="3.2",
